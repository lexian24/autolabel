...
def _setup_loguru(logger_level: str) -> None:
    ...
    cache_dir: str
    if os.name == "nt":
        cache_dir = os.path.join(os.environ["LOCALAPPDATA"], "autolabel")
    else:
        cache_dir = os.path.expanduser("~/.cache/autolabel")

    os.makedirs(cache_dir, exist_ok=True)

    log_file = os.path.join(cache_dir, "autolabel.log")
    logger.add(
        log_file,
        colorize=True,
        level="DEBUG",
...
def main():
    ...
    default_config_file = os.path.join(os.path.expanduser("~"), ".autolabelrc")
    parser.add_argument(
        "--config",
        dest="config",
