...
from .vlm_prompt_widget import VlmPromptWidget
from .vlm_categories_widget import VlmCategoriesWidget

from .ai_label_widget import AiLabelWidget  
from .vlm_bbox_detection_widget import VlmBboxDetectionWidget
